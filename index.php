...
<body>
    <div id="header">
        <nav>
            <ul id="sidemenu">
                ...
                <li><a href="./navBar_pages/news-update.php">News Updates</a></li>
                <li><a href="./navBar_pages/services.php">Services</a></li>
    ...
    <div class="news-section" id="newsSection">
        ...
        <div class="news-card">
            ...
            <div class="news-content">
                <p class="news-category">Football</p>
                <h3 class="news-title">Transfer Centre LIVE! Gallagher latest as Forest sign 'Portuguese
                    Grealish'</h3>
                <a href="#" class="news-link">Read more ></a>
            </div>
        </div>
