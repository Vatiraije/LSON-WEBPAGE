...
<head>
    ...
    <title>LSON - Namibian Bowling</title>
    <style>
        body, html {
            margin: 0;
            padding: 0;
            font-family: Arial, sans-serif;
            background: url('./images/Bowling images/bowling-bg.jpg') no-repeat center center fixed;
...
<body>
    <div class="header">
        <h1>LSON - Namibian Bowling</h1>
        <p>Your source for all things Namibian Bowling</p>
    </div>
    ...
    <div class="vertical-nav">
        ...
        <a href="bowling.php" class="active">Bowling</a>
    ...
    <div class="main-content">
        <section id="leagues" class="section">
            <div class="section-header">
                <h2>Bowling Leagues</h2>
                <p>Explore the latest updates, news, and standings from Namibian Bowling.</p>
            </div>
            ...
            <div class="content">
                ...
                <article>
                    ...
                    <img src="images/bowling.jpg" alt="BOWLING PREMIER LEAGUE">
                </article>
                <article>
                    <h3>First to new updates</h3>
                    <p>Latest updates and standings from the Namibian Bowling.</p>
                    <img src="images/bowling2.jpeg" alt="BOWLING PREMIER LEAGUE">
                </article>
                <img src="images/bowling3.jpeg" alt="BOWLING PREMIER LEAGUE">
        ...
        <section id="players" class="section">
            <div class="section-header">
                ...
                <p>Get to know the top players in Namibian Bowling.</p>
            </div>
